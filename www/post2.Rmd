...
```{r echo=FALSE, fig.align = 'center', out.width= "25%", out.extra='style="padding:10px"', fig.cap="Patricia Hill Collins"}
knitr::include_graphics("images/patriciahillcollins.jpg")
```

So, how do we begin ethical reform in these companies? From a base level, it needs to come from both the privatized industry as well as the U.S. federal government to dismantle the perpetuation of capitalist idealologies as an excuse for competitive innovation. In respect to the required strength of the resistance, Patricia Hill Collins puts it best:  
